...
import 'ChongQingTimePlayModelChoiceInterface.dart';


class ChongQingTimePlayModelChoiceUtils {
  ...
  ChongQingTimePlayModelChoiceUtils._();

  static ChongQingTimePlayModelChoiceUtils _instance;

  static ChongQingTimePlayModelChoiceUtils getInstance() {
    if (_instance == null) {
      _instance = ChongQingTimePlayModelChoiceUtils._();
    }
  ...
  getPlayModeChoiceNumList(Play11Choice5DataPlayBeen playBeen, ChongQingTimePlayModelChoiceInterface modelChoiceInterface) {
    ...
    if (modelChoiceInterface != null) {
      modelChoiceInterface.setChongQingTimePlayChoiceValue(isSingle, sumValue, cpChoiceNum, cpChoiceTitle,
