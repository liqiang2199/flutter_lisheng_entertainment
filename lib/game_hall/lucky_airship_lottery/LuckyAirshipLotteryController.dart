...
import 'lucky_airship_view/LuckyAirshipBettingView.dart';
 ...
 */
///
class LuckyAirshipLotteryController extends StatefulWidget{

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _LuckyAirshipLotteryController();
  }

}

class _LuckyAirshipLotteryController extends BaseController<LuckyAirshipLotteryController> with SingleTickerProviderStateMixin{
  int _segmentedIndex = 2;//顶部菜单 切换
  // 显示那个 对应的界面 initialPage
  PageController mPageController = PageController(initialPage: 2);
  var isPageCanChanged = true;
  String _colorVarietyID = "13";
  ...
  Widget _pageViewIndex(var index) {
    ...
    if (index == 2) {
      return LuckyAirshipBettingView("$_colorVarietyID");
    }
    if (index == 3) {
