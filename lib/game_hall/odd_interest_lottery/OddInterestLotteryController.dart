...
import 'odd_interest_view/OddInterestLotteryBettingView.dart';
 ...
 */
///
class OddInterestLotteryController extends StatefulWidget{

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _OddInterestLotteryController();
  }

}

class _OddInterestLotteryController extends BaseController<OddInterestLotteryController> with SingleTickerProviderStateMixin{
  ...
  Widget _pageViewIndex(var index) {
    ...
    if (index == 2) {
      return OddInterestLotteryBettingView(colorVarietyID: _colorVarietyID,);
    }
    if (index == 3) {
