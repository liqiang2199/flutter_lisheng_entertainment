 ...
 */
///
class PlayModeTencentCentLotteryController extends StatefulWidget{

  final List<Play11Choice5DataPlayBeen> playModeBeenList;
  final String colorVarietyID;

  const PlayModeTencentCentLotteryController({
    Key key,
  ...
  State<StatefulWidget> createState() {
    ...
    return _PlayModeTencentCentLotteryController(this.playModeBeenList, this.colorVarietyID);
  }

}

class _PlayModeTencentCentLotteryController extends BaseController<PlayModeTencentCentLotteryController> implements PlayMode11Choice5Handler {
  ...
  _PlayModeTencentCentLotteryController(
      this.playModeBeenList,
