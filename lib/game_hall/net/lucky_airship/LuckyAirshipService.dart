...
class LuckyAirshipService extends GameCommonService {
   ...
   */
  ///
  void hanoiOneGetGDBets(BuildContext context,LuckyAirshipHandler hanoiBettingHandler
   ...
   */
  ///
  void oddInterestLaterFourGetGDBets(BuildContext context,LuckyAirshipHandler hanoiBettingHandler
      , List<String> oneNum, List<String> twoNum,
   ...
   */
  ///
  void hanoiOneGetGDBetsSpan(BuildContext context,LuckyAirshipHandler hanoiBettingHandler
  ...
  /// 随机单式
  void hanoiOneGetGDBetsRandomSingle(BuildContext context,LuckyAirshipHandler hanoiBettingHandler
  ...
  /// 输入单式
  void hanoiOneGetGDBetsEditSingle(BuildContext context,LuckyAirshipHandler hanoiBettingHandler
      ,List<String> oneNum, String playID, bool isBetting, int multiple, String colorVarietyID) {
    CalculationBettingNumDataBeen calculationBettingNumBeen = new CalculationBettingNumDataBeen(new List(),0,"0.00","0.00","0.00");//注数 和 金额
    if (oneNum.length <= 0) {
      if (isBetting) {
   ...
   */
  ///
  void hanoiOneGetGDBetsOptional(BuildContext context,LuckyAirshipHandler hanoiBettingHandler, List<String> oneNum
   ...
   */
  ///
  void hanoiOneGetGDBetsOptionalGroup(BuildContext context,LuckyAirshipHandler hanoiBettingHandler, List<String> oneNum
   ...
   */
  ///
  void hanoiOneGetGDBetsOptionalSingle(BuildContext context,LuckyAirshipHandler hanoiBettingHandler, List<String> oneNum
   ...
   */
  ///
  void hanoiOneGetGDBetsDragonTiger(BuildContext context,LuckyAirshipHandler hanoiBettingHandler
